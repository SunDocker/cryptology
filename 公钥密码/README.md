...
>   -   DLP（离散对数问题）
>
>       >   等式$x^a\equiv b~mod~p$中，给定x、b和p，求a是困难的
>
>       -   ElGamal
>
>   -   ECDLP（椭圆曲线上的离散对数问题）
...
基于DLP的DH密钥交换协议（公开-私密-公开-私密）

-   A和B公开商量g
-   A和B各自选定私密的a和b，计算$g^a$和$g^b$
-   将$g^a$和$g^b$公开发送给对方
-   A和B各自私密计算$(g^b)^a$和$(g^a)^b$

基于ECDLP的DH密钥交换协议（公开-私密-公开-私密）

-   A和B公开商量G
-   A和B各自选定私密的$n_A$和$n_B$，计算$n_A*G$和$n_B*G$
-   将$n_A*G$和$n_B*G$公开发送给对方
-   A和B各自私密计算$n_A*n_B*G$
